import { Download, Search, ChevronDown, FileDown } from 'lucide-react'
        ...
        {showSearch && (
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2.5 bg-slate-800/50 border border-slate-700/50 rounded-lg text-sm text-slate-300 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all w-64"
            />
          </div>
        )}
